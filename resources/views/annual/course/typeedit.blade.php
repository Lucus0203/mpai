            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        @endif
                        {{Form::open(['method'=>'PATCH','url'=>'/annual/coursetype/'.$coursetype->id,'class'=>'form-horizontal','role'=>'form','id'=>'courseform'])}}
                        <div class="form-group">
                            {{ Form::label('name', '名称', array('class' => 'col-sm-1 control-label')) }}
                            <div class="col-sm-2">
                                {{ Form::text('name',$coursetype->name,['class'=>'form-control','placeholder'=>'请输入名称','id'=>'price']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            {{ Form::label('ispublic', '状态', array('class' => 'col-sm-1 control-label')) }}
                            <div class="col-sm-2">
                                {{ Form::select('ispublic', array('1'=>'发布','2'=>'不发布'), $coursetype->ispublic, ['class' => 'form-control']) }}
                            </div>
                        </div>
