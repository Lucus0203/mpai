            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        @endif
                        {{Form::open(['method'=>'post','url'=>'/annual/course/','class'=>'form-horizontal','role'=>'form','id'=>'courseform'])}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                {{ Form::text('price',null,['class'=>'form-control','placeholder'=>'请输入价格','id'=>'price']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            {{ Form::label('day', '天数', array('class' => 'col-sm-1 control-label')) }}
                            <div class="col-sm-2">
                                {{ Form::text('day',null,['class'=>'form-control','placeholder'=>'请输入天数','id'=>'day']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            {{ Form::label('title', '课程标题', array('class' => 'col-sm-1 control-label')) }}
                            <div class="col-sm-8">
                                {{ Form::text('title',null,['class'=>'form-control','placeholder'=>'请输入标题','id'=>'title']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            {{ Form::label('info', '课程收益', array('class' => 'col-sm-1 control-label')) }}
                            <div class="col-sm-8">
                                {{ Form::textarea('info',null,['class'=>'form-control','placeholder'=>'请输入课程收益','id'=>'info']) }}
                            </div>
                        </div>
                        <div class="form-group">
                            {{ Form::label('target', '目标对象', array('class' => 'col-sm-1 control-label')) }}
                            <div class="col-sm-8">
                                {{ Form::textarea('target',null,['class'=>'form-control','placeholder'=>'请输入目标对象','id'=>'target']) }}
                            </div>
                        </div>
